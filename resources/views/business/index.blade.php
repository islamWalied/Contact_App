            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="flex items-center justify-end">
                       ...
                       dark:hover:bg-gray-700">Deleted Business</a>
                       ...
                       focus:ring-gray-200 dark:focus:ring-gray-700 dark:bg-gray-800
                       dark:text-gray-400 dark:border-gray-600 dark:hover:text-white
                       dark:hover:bg-gray-700">Add New Business</a>
                    </div>
                                ...
                                @foreach($business as $bus)
                                    <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                                        ...
                                        <td class="px-6 py-4">
                                            ...
                                            <form action="{{route('business.destroy',$bus->id)}}" method="post" class="inline">
                                                @csrf
                                                @method('DELETE')
